...
Su principal punto débil es la salud: la raza tiene predisposición a problemas cardíacos (enfermedad mitral) y siringomielia. Compra solo a criadores que hagan pruebas genéticas certificadas. Presupuesta un seguro veterinario.
...
Un perro adulto ya tiene su personalidad formada. No hay sorpresas: si el perro es tranquilo en la protectora, será tranquilo en tu casa. Si no ladra ante estímulos, no empezará a hacerlo. Con un cachorro de raza, por muy buenas que sean las predicciones basadas en la raza, siempre hay incertidumbre sobre cómo será de adulto.
...
## Conclusión: el mejor perro para tu piso eres tú quien lo decide
