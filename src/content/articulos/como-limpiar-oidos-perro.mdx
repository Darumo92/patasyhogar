...
Según la <a href="https://www.avepa.org" target="_blank" rel="nofollow noopener">AVEPA</a>, la otitis es una de las tres consultas veterinarias más frecuentes en perros. La limpieza de oídos es una de las rutinas de higiene más importantes y más ignoradas, junto con el [cepillado regular](/higiene/mejor-cepillo-perro/). Un oído sucio es caldo de cultivo para bacterias y levaduras que causan otitis, una de las consultas veterinarias más frecuentes en perros.
