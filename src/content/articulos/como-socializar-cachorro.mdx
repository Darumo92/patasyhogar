...
faqs:
  ...
  - pregunta: "¿Cuántas experiencias nuevas necesita un cachorro al día?"
    respuesta: "No hay un número mágico, pero los expertos recomiendan que el cachorro tenga al menos 1-2 experiencias nuevas positivas cada día durante el periodo crítico. Esto incluye conocer personas diferentes (niños, ancianos, personas con gafas/sombrero), superficies (metal, hierba, arena), sonidos (aspiradora, truenos, tráfico) y otros animales. La calidad importa más que la cantidad: una experiencia traumática hace más daño que diez positivas."
---
